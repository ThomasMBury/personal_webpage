function [ data_out ] = vacc_sde_erlang_seasonal( y0, tmax, k, choose_risk, wl, wh, d, num_realisations, sigma )
% vacc_sde runs a stochastic simulation of the vaccine imitation model
% WITH Erlang distributed infectious period
% AND seasonally varying transmission rate
%
...
% for this
system = @(t,y)[u*(1-y(22))-bfun(t)*y(1)*sum(y(2:21))-u*y(1);...  %y(1)
                bfun(t)*y(1)*sum(y(2:21))-(n*g + u)*y(2);...      %y(2)
